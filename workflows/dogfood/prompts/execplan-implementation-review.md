...
- When reporting remaining findings, cite synthesized finding ids from the final review artifact so the feedback step can write exact disposition coverage.
