...
- Read `$SCHERZO_RUN_ROOT/state/implementation/scherzo-plan-completion-recovery.json` and `$SCHERZO_RUN_ROOT/state/implementation/scherzo-plan-completion-verdict.json` first.
...
1. Inspect `$SCHERZO_WORKSPACE_DRIVER status --human` and read `$SCHERZO_RUN_ROOT/state/implementation/scherzo-plan-completion-recovery.json` plus `$SCHERZO_RUN_ROOT/state/implementation/scherzo-plan-completion-verdict.json`.
