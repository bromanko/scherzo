...
This guidance describes how to author and implement execution plans — thorough, self-contained design documents that a coding agent can follow to deliver a working feature or system change. ExecPlans are living documents: they are written before implementation begins, updated continuously as work proceeds, and serve as the single source of truth throughout the process.
...
When creating an ExecPlan, follow the rules in this guidance _to the letter_. Be thorough in reading (and re-reading) source material to produce an accurate specification. Start from the skeleton and flesh it out as you do your research.
