...
- [ ] Custom config loaded before workspace creation
- [ ] Invalid JSON returns StartFailed with clear error message
- [ ] Missing config directory works (empty config used)
- [ ] Custom config passed to workspace.create()
