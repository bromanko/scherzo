...
- [ ] AgentCustomConfig type defined
- [ ] load() reads both files when present
- [ ] Returns empty config when directory missing
- [ ] Returns error for malformed settings.json
- [ ] Unit tests in `test/scherzo/config/agent_config_test.gleam`
