...
- [ ] create() accepts optional custom config
- [ ] CLAUDE.md written to workspace root when instructions present
- [ ] settings.json merged when custom settings present
- [ ] destroy() restores both CLAUDE.md and settings.json
