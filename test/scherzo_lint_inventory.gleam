...
fn usage() -> String {
  "Usage: gleam run -m scherzo_lint_inventory -- [--path src] [--format markdown] [--output build/public-api-style-inventory.md]\n\nScans production Gleam source for staged public API style candidates and writes an inventory report. Findings are data, not lint failures."
}
