...
pub fn v2_workflow_fingerprint_includes_structured_output_and_contract_types_test() {
  ...
  let changed_command =
    parse(
      "version: 1\nid: execplan-v2\ncontract:\n  version: 1\n  outputs:\n    exec_plan_bundle:\n      type: exec_plan_bundle\n      source:\n        step: materialize_bundle\n        field: stdout\nsteps:\n  - id: draft\n    kind: agent\n    prompt: prompts/execplan-v2-draft.md\n    workspace: main\n    structured_output:\n      artifact_name: implementation_pack_submission\n      source:\n        type: pi_tool_call\n        tool_name: submit_implementation_pack_submission\n        parameters_schema_path: .scherzo/workflows/schemas/implementation-pack-submission.v2.schema.json\n      validators:\n        - name: shape\n          type: json_schema\n          path: .scherzo/workflows/schemas/implementation-pack-submission.v2.schema.json\n  - id: materialize_bundle\n    kind: command\n    depends_on: [draft]\n    run: scripts/scherzo-execplan-v2 materialize-bundle --changed\n",
    )
  ...
  let fingerprint = workflow_fingerprint.for_dag("execplan-v2", base)
  assert fingerprint
    != workflow_fingerprint.for_dag("execplan-v2", changed_schema)
  assert fingerprint
    != workflow_fingerprint.for_dag("execplan-v2", changed_tool)
  assert fingerprint
    != workflow_fingerprint.for_dag("execplan-v2", changed_command)
  assert fingerprint
    != workflow_fingerprint.for_dag("execplan-v2", changed_output_type)
  assert string.contains(
    workflow_fingerprint.canonical_input(base),
    "exec_plan_bundle",
  )
