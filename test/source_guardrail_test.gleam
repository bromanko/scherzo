...
fn oversized_source_baseline() -> List(SourceLimit) {
  [
    ...
    SourceLimit("src/scherzo/orchestrator/core.gleam", 1155, 9),
    SourceLimit("src/scherzo/orchestrator/daemon.gleam", 6979, 73),
    SourceLimit(
      "src/scherzo/orchestrator/daemon_transition_shell.gleam",
      717,
      21,
    ),
    SourceLimit("src/scherzo/orchestrator/startup_recovery.gleam", 1078, 19),
    SourceLimit("src/scherzo/orchestrator/effect_runner.gleam", 1062, 21),
    SourceLimit("src/scherzo/orchestrator/service.gleam", 2114, 25),
    SourceLimit("src/scherzo/orchestrator/transition.gleam", 3522, 24),
    SourceLimit("src/scherzo/orchestrator/transitions/claims.gleam", 1156, 20),
    SourceLimit("src/scherzo/state/ledger.gleam", 1008, 3),
    SourceLimit("src/scherzo/pi/protocol.gleam", 1067, 3),
    SourceLimit("src/scherzo/state/artifact_store.gleam", 1175, 7),
    SourceLimit("src/scherzo/state/local_artifacts.gleam", 1232, 8),
    SourceLimit("src/scherzo/state/projection.gleam", 6859, 12),
    SourceLimit("src/scherzo/state/record.gleam", 4472, 10),
    SourceLimit("src/scherzo/state/recovery.gleam", 3274, 16),
    ...
    SourceLimit("src/scherzo/workflow_checkpoint.gleam", 1293, 15),
