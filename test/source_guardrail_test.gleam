...
fn oversized_source_baseline() -> List(SourceLimit) {
  [
    ...
    SourceLimit("src/scherzo/orchestrator/daemon.gleam", 6859, 56),
    ...
    SourceLimit("src/scherzo/state/projection.gleam", 4589, 2),
    SourceLimit("src/scherzo/state/record.gleam", 2808, 1),
    SourceLimit("src/scherzo/state/recovery.gleam", 2369, 13),
    ...
    SourceLimit("src/scherzo/workflow_dag.gleam", 1236, 4),
    SourceLimit("src/scherzo/workflow_run.gleam", 3434, 29),
