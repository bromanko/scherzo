...
fn oversized_source_baseline() -> List(SourceLimit) {
  [
    ...
    SourceLimit("src/scherzo/control/command.gleam", 1171, 0),
    SourceLimit("src/scherzo/control/protocol.gleam", 2132, 8),
    ...
    SourceLimit("src/scherzo/ctl.gleam", 3269, 25),
    SourceLimit("src/scherzo/ctl/command_registry.gleam", 1549, 5),
    ...
    SourceLimit("src/scherzo/orchestrator/daemon.gleam", 10_380, 87),
    SourceLimit(
    ...
    SourceLimit("src/scherzo/orchestrator/service.gleam", 2194, 27),
    ...
    SourceLimit("src/scherzo/workflow_dag.gleam", 1899, 9),
