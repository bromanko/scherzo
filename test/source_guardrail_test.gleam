...
fn oversized_source_baseline() -> List(SourceLimit) {
  [
    ...
    SourceLimit("src/scherzo/artifact_publication_config.gleam", 1565, 2),
    ...
    SourceLimit("src/scherzo/orchestrator/daemon.gleam", 6594, 70),
    ...
    SourceLimit("src/scherzo/workflow_contract.gleam", 1450, 1),
    SourceLimit("src/scherzo/workflow_contract_manifest.gleam", 1015, 5),
    SourceLimit("src/scherzo/workflow_dag.gleam", 1703, 8),
    SourceLimit("src/scherzo/workflow_run/contract_io.gleam", 1051, 13),
