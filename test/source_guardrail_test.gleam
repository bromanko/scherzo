...
fn oversized_source_baseline() -> List(SourceLimit) {
  [
    ...
    SourceLimit("src/scherzo/control/command.gleam", 1014, 0),
    ...
    SourceLimit("src/scherzo/ctl/command_registry.gleam", 1246, 4),
    ...
    SourceLimit("src/scherzo/orchestrator/daemon.gleam", 9359, 85),
    SourceLimit(
