...
fn oversized_source_baseline() -> List(SourceLimit) {
  [
    ...
    SourceLimit("src/scherzo/orchestrator/daemon.gleam", 10_641, 89),
    SourceLimit(
    ...
    SourceLimit("src/scherzo/orchestrator/transition_types.gleam", 500, 21),
    SourceLimit("src/scherzo/orchestrator/transitions/claims.gleam", 1127, 20),
    SourceLimit("src/scherzo/orchestrator/transitions/operator.gleam", 1020, 14),
    ...
    SourceLimit("src/scherzo/workflow_checkpoint.gleam", 1454, 16),
