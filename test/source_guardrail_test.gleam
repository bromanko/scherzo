...
fn oversized_source_baseline() -> List(SourceLimit) {
  [
    ...
    SourceLimit("src/scherzo/control/command.gleam", 1145, 0),
    SourceLimit("src/scherzo/control/protocol.gleam", 2089, 9),
    ...
    SourceLimit("src/scherzo/ctl/command_registry.gleam", 1525, 5),
    ...
    SourceLimit("src/scherzo/orchestrator/daemon.gleam", 9791, 86),
    SourceLimit(
      "src/scherzo/orchestrator/daemon_transition_shell.gleam",
      734,
      21,
    ),
    SourceLimit("src/scherzo/orchestrator/startup_recovery.gleam", 1125, 20),
    ...
    SourceLimit("src/scherzo/state/projection.gleam", 7117, 12),
    SourceLimit("src/scherzo/state/record.gleam", 4602, 10),
    SourceLimit("src/scherzo/state/recovery.gleam", 3756, 18),
    ...
    SourceLimit("src/scherzo/workflow_repair.gleam", 1859, 8),
