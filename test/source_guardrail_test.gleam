...
fn oversized_source_baseline() -> List(SourceLimit) {
  [
    ...
    SourceLimit("src/scherzo/control/protocol.gleam", 1920, 9),
    ...
    SourceLimit("src/scherzo/control/remote/ui_websocket_client.gleam", 1232, 6),
    SourceLimit("src/scherzo/orchestrator/daemon.gleam", 8183, 82),
    SourceLimit(
    ...
    SourceLimit("src/scherzo/state/recovery.gleam", 3742, 17),
