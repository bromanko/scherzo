...
fn oversized_source_baseline() -> List(SourceLimit) {
  [
    ...
    SourceLimit("src/scherzo/orchestrator/daemon.gleam", 7327, 57),
    ...
    SourceLimit("src/scherzo/state/projection.gleam", 6091, 11),
    SourceLimit("src/scherzo/state/record.gleam", 3912, 9),
