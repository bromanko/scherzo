...
fn oversized_source_baseline() -> List(SourceLimit) {
  [
    ...
    SourceLimit("src/scherzo/state/projection.gleam", 5529, 2),
    SourceLimit("src/scherzo/state/record.gleam", 3553, 1),
