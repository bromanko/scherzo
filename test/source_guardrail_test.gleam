...
fn oversized_source_baseline() -> List(SourceLimit) {
  [
    ...
    SourceLimit("src/scherzo/config/types.gleam", 1006, 5),
    ...
    SourceLimit("src/scherzo/ctl.gleam", 3304, 25),
    SourceLimit("src/scherzo/ctl/command_registry.gleam", 1568, 5),
    ...
    SourceLimit("src/scherzo/orchestrator/daemon.gleam", 10_797, 93),
    SourceLimit(
    ...
    SourceLimit("src/scherzo/orchestrator/effect_runner.gleam", 1127, 22),
    ...
    SourceLimit("src/scherzo/state/ledger.gleam", 1681, 6),
    ...
    SourceLimit("src/scherzo/state/projection.gleam", 7263, 12),
