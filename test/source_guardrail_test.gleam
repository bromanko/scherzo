...
fn oversized_source_baseline() -> List(SourceLimit) {
  [
    ...
    SourceLimit("src/scherzo/agent/turn_loop.gleam", 1006, 18),
    ...
    SourceLimit("src/scherzo/config/types.gleam", 1016, 5),
    SourceLimit("src/scherzo/control/command.gleam", 1207, 0),
    SourceLimit("src/scherzo/control/protocol.gleam", 2181, 8),
    SourceLimit("src/scherzo/control/query/codec.gleam", 1059, 6),
    SourceLimit("src/scherzo/control/remote/ui_protocol.gleam", 1365, 7),
    SourceLimit("src/scherzo/control/remote_harness.gleam", 1012, 9),
    SourceLimit("src/scherzo/cleanup.gleam", 1558, 20),
    SourceLimit("src/scherzo/cleanup/workspaces.gleam", 1550, 20),
    SourceLimit("src/scherzo/ctl.gleam", 3329, 25),
    SourceLimit("src/scherzo/ctl/command_registry.gleam", 1587, 5),
    SourceLimit("src/scherzo/ctl/artifact_publication.gleam", 1146, 14),
    SourceLimit("src/scherzo/ctl/artifact_publication_retry.gleam", 1010, 18),
    SourceLimit("src/scherzo/ctl/state_handlers.gleam", 1283, 14),
    SourceLimit("src/scherzo/linear.gleam", 1496, 9),
    SourceLimit("src/scherzo/local_workflow_run.gleam", 939, 22),
    SourceLimit("src/scherzo/orchestrator/core.gleam", 1155, 10),
    SourceLimit("src/scherzo/control/remote/ui_websocket_client.gleam", 1354, 8),
    SourceLimit("src/scherzo/orchestrator/daemon.gleam", 11_017, 93),
    SourceLimit(
      "src/scherzo/orchestrator/daemon_transition_shell.gleam",
      826,
      24,
    ),
    SourceLimit("src/scherzo/orchestrator/scheduled_runtime.gleam", 1024, 5),
    SourceLimit("src/scherzo/orchestrator/startup_recovery.gleam", 1245, 20),
    SourceLimit("src/scherzo/orchestrator/effect_runner.gleam", 1136, 22),
    SourceLimit("src/scherzo/orchestrator/service.gleam", 2196, 28),
    ...
    SourceLimit("src/scherzo/orchestrator/transition_types.gleam", 501, 21),
    SourceLimit("src/scherzo/orchestrator/transitions/claims.gleam", 1127, 20),
    SourceLimit("src/scherzo/state/ledger.gleam", 2288, 12),
    SourceLimit("src/scherzo/pi/protocol.gleam", 1067, 3),
    SourceLimit("src/scherzo/runtime_bundle.gleam", 1005, 17),
    SourceLimit("src/scherzo/session/event.gleam", 1331, 4),
    SourceLimit("src/scherzo/state/artifact_store.gleam", 1248, 7),
    SourceLimit("src/scherzo/state/local_artifacts.gleam", 1244, 8),
    SourceLimit("src/scherzo/state/projection.gleam", 7542, 12),
    SourceLimit("src/scherzo/state/record.gleam", 4656, 10),
    SourceLimit("src/scherzo/state/recovery.gleam", 3863, 19),
    SourceLimit("src/scherzo/step_artifact.gleam", 1563, 9),
    SourceLimit("src/scherzo/terminal/render.gleam", 1109, 6),
    ...
    SourceLimit("src/scherzo/workstream/start.gleam", 1126, 18),
    SourceLimit("src/scherzo/workflow_output_recollection.gleam", 1072, 15),
    SourceLimit("src/scherzo/workflow_recovery_planner.gleam", 1225, 4),
    SourceLimit("src/scherzo/workflow_repair.gleam", 2495, 13),
    SourceLimit("src/scherzo/workflow_checkpoint.gleam", 1472, 16),
    SourceLimit("src/scherzo/workflow_contract.gleam", 1806, 1),
    SourceLimit("src/scherzo/workflow_contract_manifest.gleam", 1181, 5),
    SourceLimit("src/scherzo/workflow_dag.gleam", 1908, 9),
    SourceLimit("src/scherzo/workflow_run/contract_io.gleam", 1216, 15),
    SourceLimit("src/scherzo/workflow_run.gleam", 5660, 39),
    SourceLimit("src/scherzo/workspace_run.gleam", 1301, 12),
    SourceLimit("src/scherzo_port_ffi.erl", 1224, 0),
  ]
}
