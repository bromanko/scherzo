...
fn oversized_source_baseline() -> List(SourceLimit) {
  [
    ...
    SourceLimit("src/scherzo/control/command.gleam", 1155, 0),
    SourceLimit("src/scherzo/control/protocol.gleam", 2105, 9),
    ...
    SourceLimit("src/scherzo/ctl.gleam", 3236, 25),
    SourceLimit("src/scherzo/ctl/command_registry.gleam", 1540, 5),
    ...
    SourceLimit("src/scherzo/control/remote/ui_websocket_client.gleam", 1353, 8),
    SourceLimit("src/scherzo/orchestrator/daemon.gleam", 10_337, 87),
    SourceLimit(
    ...
    SourceLimit("src/scherzo/orchestrator/service.gleam", 2141, 27),
    ...
    SourceLimit("src/scherzo/state/artifact_store.gleam", 1234, 7),
    SourceLimit("src/scherzo/state/local_artifacts.gleam", 1244, 8),
    SourceLimit("src/scherzo/state/projection.gleam", 7140, 12),
    SourceLimit("src/scherzo/state/record.gleam", 4620, 10),
    ...
    SourceLimit("src/scherzo/workflow_repair.gleam", 1859, 9),
    SourceLimit("src/scherzo/workflow_checkpoint.gleam", 1376, 16),
