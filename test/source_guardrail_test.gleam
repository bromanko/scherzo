...
fn oversized_source_baseline() -> List(SourceLimit) {
  [
    ...
    SourceLimit("src/scherzo/orchestrator/daemon.gleam", 6878, 56),
    ...
    SourceLimit("src/scherzo/state/projection.gleam", 4758, 2),
    SourceLimit("src/scherzo/state/record.gleam", 2922, 1),
    ...
    SourceLimit("src/scherzo/workflow_contract.gleam", 1186, 0),
    SourceLimit("src/scherzo/workflow_dag.gleam", 1384, 5),
    SourceLimit("src/scherzo/workflow_run.gleam", 4441, 32),
