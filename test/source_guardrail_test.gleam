...
fn oversized_source_baseline() -> List(SourceLimit) {
  [
    ...
    SourceLimit("src/scherzo/orchestrator/daemon.gleam", 7315, 57),
    SourceLimit("src/scherzo/orchestrator/service.gleam", 2118, 25),
    SourceLimit("src/scherzo/orchestrator/transition.gleam", 3165, 21),
    ...
    SourceLimit("src/scherzo/state/projection.gleam", 6060, 11),
    SourceLimit("src/scherzo/state/record.gleam", 3840, 9),
    SourceLimit("src/scherzo/state/recovery.gleam", 2889, 15),
    ...
    SourceLimit("src/scherzo/workflow_dag.gleam", 1645, 6),
