...
fn oversized_source_baseline() -> List(SourceLimit) {
  [
    ...
    SourceLimit("src/scherzo/orchestrator/daemon.gleam", 7413, 75),
    SourceLimit(
      "src/scherzo/orchestrator/daemon_transition_shell.gleam",
      727,
      21,
    ),
    SourceLimit("src/scherzo/orchestrator/startup_recovery.gleam", 1082, 20),
    SourceLimit("src/scherzo/orchestrator/effect_runner.gleam", 1063, 21),
    ...
    SourceLimit("src/scherzo/state/recovery.gleam", 3621, 17),
