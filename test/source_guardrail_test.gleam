...
fn oversized_source_baseline() -> List(SourceLimit) {
  [
    ...
    SourceLimit("src/scherzo/artifact_publication_config.gleam", 1314, 2),
    SourceLimit("src/scherzo/artifact_publication_planner.gleam", 1117, 9),
    SourceLimit("src/scherzo/artifact_repository/github.gleam", 1518, 13),
    ...
    SourceLimit("src/scherzo/ctl/artifact_publication.gleam", 1138, 14),
    ...
    SourceLimit("src/scherzo/workflow_contract.gleam", 1446, 1),
    SourceLimit("src/scherzo/workflow_contract_manifest.gleam", 1006, 5),
