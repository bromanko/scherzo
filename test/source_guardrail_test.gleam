...
fn oversized_source_baseline() -> List(SourceLimit) {
  [
    ...
    SourceLimit("src/scherzo/orchestrator/daemon.gleam", 7156, 57),
    ...
    SourceLimit("src/scherzo/state/artifact_store.gleam", 1093, 8),
    SourceLimit("src/scherzo/state/local_artifacts.gleam", 1155, 6),
    SourceLimit("src/scherzo/state/projection.gleam", 6025, 2),
    SourceLimit("src/scherzo/state/record.gleam", 3767, 1),
    SourceLimit("src/scherzo/state/recovery.gleam", 2789, 15),
