...
fn oversized_source_baseline() -> List(SourceLimit) {
  [
    ...
    SourceLimit("src/scherzo/control/command.gleam", 1189, 0),
    SourceLimit("src/scherzo/control/protocol.gleam", 2154, 8),
    ...
    SourceLimit("src/scherzo/ctl.gleam", 3273, 25),
    SourceLimit("src/scherzo/ctl/command_registry.gleam", 1557, 5),
    ...
    SourceLimit("src/scherzo/orchestrator/daemon.gleam", 10_579, 88),
    SourceLimit(
    ...
    SourceLimit("src/scherzo/runtime_bundle.gleam", 1005, 16),
    ...
    SourceLimit("src/scherzo/workflow_repair.gleam", 2367, 13),
