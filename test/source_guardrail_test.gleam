...
fn oversized_source_baseline() -> List(SourceLimit) {
  [
    ...
    SourceLimit("src/scherzo/config.gleam", 2596, 8),
    SourceLimit("src/scherzo/control/protocol.gleam", 1607, 7),
    SourceLimit("src/scherzo/ctl.gleam", 2791, 19),
    SourceLimit("src/scherzo/linear.gleam", 1496, 7),
    SourceLimit("src/scherzo/orchestrator/core.gleam", 1308, 8),
    SourceLimit("src/scherzo/orchestrator/daemon.gleam", 6573, 59),
    SourceLimit("src/scherzo/orchestrator/service.gleam", 2118, 25),
    SourceLimit("src/scherzo/orchestrator/transition.gleam", 3166, 21),
    SourceLimit("src/scherzo/pi/protocol.gleam", 1067, 3),
    SourceLimit("src/scherzo/state/artifact_store.gleam", 1134, 7),
    SourceLimit("src/scherzo/state/local_artifacts.gleam", 1232, 7),
    SourceLimit("src/scherzo/state/projection.gleam", 6126, 11),
    SourceLimit("src/scherzo/state/record.gleam", 4009, 9),
    SourceLimit("src/scherzo/state/recovery.gleam", 2946, 15),
    ...
    SourceLimit("src/scherzo/workstream/start.gleam", 1062, 18),
    ...
    SourceLimit("src/scherzo/workflow_dag.gleam", 1703, 7),
