...
fn oversized_source_baseline() -> List(SourceLimit) {
  [
    ...
    SourceLimit("src/scherzo/cleanup/workspaces.gleam", 1245, 20),
    SourceLimit("src/scherzo/ctl.gleam", 3236, 22),
    SourceLimit("src/scherzo/ctl/command_registry.gleam", 1214, 4),
    ...
    SourceLimit("src/scherzo/state/projection.gleam", 7107, 12),
    SourceLimit("src/scherzo/state/record.gleam", 4598, 10),
