...
fn oversized_source_baseline() -> List(SourceLimit) {
  [
    ...
    SourceLimit("src/scherzo/orchestrator/daemon.gleam", 6933, 73),
    ...
    SourceLimit("src/scherzo/orchestrator/transition.gleam", 3480, 24),
    SourceLimit("src/scherzo/orchestrator/transitions/claims.gleam", 1073, 20),
