...
fn oversized_source_baseline() -> List(SourceLimit) {
  [
    ...
    SourceLimit("src/scherzo/orchestrator/core.gleam", 1323, 8),
    SourceLimit("src/scherzo/orchestrator/daemon.gleam", 6150, 59),
    SourceLimit("src/scherzo/orchestrator/service.gleam", 2118, 25),
    SourceLimit("src/scherzo/orchestrator/transition.gleam", 3180, 21),
    ...
    SourceLimit("src/scherzo/state/projection.gleam", 6136, 11),
    SourceLimit("src/scherzo/state/record.gleam", 4009, 9),
    SourceLimit("src/scherzo/state/recovery.gleam", 2982, 15),
