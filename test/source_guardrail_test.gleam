...
fn oversized_source_baseline() -> List(SourceLimit) {
  [
    ...
    SourceLimit("src/scherzo/orchestrator/daemon.gleam", 7502, 52),
    SourceLimit("src/scherzo/orchestrator/service.gleam", 1864, 24),
    ...
    SourceLimit("src/scherzo/workflow_run.gleam", 2592, 22),
