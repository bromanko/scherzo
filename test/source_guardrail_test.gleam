...
fn oversized_source_baseline() -> List(SourceLimit) {
  [
    ...
    SourceLimit("src/scherzo/control/protocol.gleam", 1666, 9),
    SourceLimit("src/scherzo/ctl.gleam", 3198, 23),
    ...
    SourceLimit("src/scherzo/orchestrator/daemon.gleam", 6255, 65),
    ...
    SourceLimit("src/scherzo/state/projection.gleam", 6424, 12),
    SourceLimit("src/scherzo/state/record.gleam", 4209, 10),
