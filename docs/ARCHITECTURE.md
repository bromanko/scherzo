...
| `scherzo_http_client_ffi.erl` | `http_client_proxy.gleam`, Linear and remote HTTP clients | Start `httpc` and apply validated standard proxy environment settings to its VM-global default profile. |
