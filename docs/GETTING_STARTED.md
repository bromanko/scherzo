...
direnv exec . scripts/scherzoctl retry-step run:<run-id> --step <step-id> --json
direnv exec . scripts/scherzoctl artifact publication retry --run <run-id> --publication <publication-id> --json
