...
Focus on missing, shallow, or misleading tests. Link any draft finding to a concrete evidence request; generic green validation is context only unless tied to a target test, reproduction, artifact, or expected observation.
